...
#import "ZBVideoPlayerControllerView.h"

static const CGFloat kVideoPlayerControllerAnimationTimeinterval = 0.3f;

@interface ZBVideoPlayerController()

@property (nonatomic, strong) ZBVideoPlayerControllerView *videoControl;
...
@implementation ZBVideoPlayerController
...
- (ZBVideoPlayerControllerView *)videoControl
{
    if (!_videoControl) {
        _videoControl = [[ZBVideoPlayerControllerView alloc] init];
    }
